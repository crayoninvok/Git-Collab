...
export default function ForgetPasswordPromotor() {
  ...
  const handleSubmit = async (values: { email: string }) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_BE}/auth/forgotPasswordPromotor`, {
        method: "POST",
        headers: {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      ...
      <div className="bg-gradient-to-br from-gray-800/90 to-black/70 backdrop-blur-md border border-gray-700 rounded-3xl p-8 lg:p-12 shadow-xl w-full max-w-[400px]">
        <h1 className="text-3xl font-bold mb-4 text-center">
          Forget <span className="text-blue-400">Password</span>
        </h1>
